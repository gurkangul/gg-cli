...
func gsdBridgeBlock() string {
	...
	sb.WriteString("rules. GSD is a planning workspace that cross-posts to gg — it does not\n")
	...
	sb.WriteString("\n")
	sb.WriteString("GSD is allowed as the developer execution environment. What is forbidden\n")
	sb.WriteString("is letting GSD-owned planning/tracker state replace gg as the canonical\n")
	sb.WriteString("task, decision, message, and review lifecycle.\n")
	sb.WriteString("\n")
