...
* [gg record](gg_record.md)	 - Record a decision or rejected approach
* [gg reembed](gg_reembed.md)	 - Migrate all Qdrant collections to the currently configured embedding model
* [gg reject](gg_reject.md)	 - Record a rejected approach (deprecated: use gg record --stance=reject)
* [gg search](gg_search.md)	 - Semantic search across decisions and rejections
